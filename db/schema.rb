...
ActiveRecord::Schema.define(:version => 20140317151010) do
  ...
  create_table "pending_events", :force => true do |t|
    t.integer  "user_id"
    t.integer  "agent_id"
    t.decimal  "lat",        :precision => 15, :scale => 10
    t.decimal  "lng",        :precision => 15, :scale => 10
  ...
  add_index "pending_events", ["agent_id", "emits_at"], :name => "index_pending_events_on_agent_id_and_emits_at"
  add_index "pending_events", ["user_id", "emits_at"], :name => "index_pending_events_on_user_id_and_emits_at"
