module Agents
  class TwitterActionAgent < Agent
    ...
    description <<~MD
      ...
      It expects to consume events generated by twitter agents where the payload is a hash of tweet information. The TwitterUserAgent is one example of a valid event producer for this Agent.
