# include_recipe 'huginn::default_settings'
# include_attribute 'huginn'
include_recipe 'huginn::setup_software'
include_recipe 'huginn::setup_users'
...
deploy "/home/huginn" do
  ...
  before_symlink do
    ...
    #   directory "/home/huginn/shared/#{dir}"
    # end
